                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-email">
                              <tbody>
                                <?php while($messagerd_data = mysqli_fetch_array($messagerd_result)) { ?>
                                <tr <?php if($messagerd_data['message_status'] == 'unread') {?> class="unread" <?php } ?>>
                                  <td>
                                  ...
                                  <td>
                                    <div class="media">
                                        <a href="read.php" class="pull-left">
                                          <img alt="" src="<?php echo $messagerd_data['sender_image']; ?>" class="media-object">
                                        </a>
                                        <a href="read.php?post_id=<?php echo $messagerd_data['id']; ?>">
                                        <div class="media-body">
                                            <span class="media-meta pull-right"><?php  echo date('M j Y g:i A', strtotime($messagerd_data['sent_at']));?></span>
                                            <h4 class="text-primary"><?php echo $messagerd_data['sender']; ?></h4>
                                            <small class="text-muted"></small>
                                            <p class="email-summary"><?php echo $messagerd_data['message_title']; ?></p>
                                        </div>
                                        </a> 
                                    </div>
                                  </td>
